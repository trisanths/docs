...
1. Visit our <Link href="https://app.cyrionlabs.com">application portal</Link>
2. Register your nonprofit organization
3. Provide required documentation
4. Receive your API key upon approval

### Managing Your Account

- **Dashboard:** <Link href="https://app.cyrionlabs.com">https://app.cyrionlabs.com</Link>
- **API Key Management:** Regenerate keys, view usage
- **Usage Analytics:** Monitor your API usage
- **Account Settings:** Update organization information

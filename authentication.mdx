...
1. **Sign up** at our <Link href="https://app.cyrionlabs.com">application portal</Link>
2. **Verify your nonprofit status** by providing required documentation
3. **Receive your API key** instantly upon approval
...
client = cyrionai.CyrionAI(api_key="sk-1234567890abcdef")
```
...
client = cyrionai.CyrionAI(api_key=os.getenv('CYRIONAI_API_KEY'))
```
...
```bash
curl https://api.cyrionlabs.com/v1/models \
